...
const Exercises = () => {
  ...
  useEffect(() => {
    const muscles = document.querySelectorAll('.muscle-groups svg g g[id]');

    const handleClick = (event) => {
      let muscleId = event.target.parentElement.id;
      navigate(`/exercise?muscle=${muscleId}`);
    };
